      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 relative">
            {/* Cinematic badge */}
            <div className="inline-flex items-center gap-2 px-5 py-2.5 glass-cyber rounded-full glow-cyan transform -rotate-1 hover:rotate-0 transition-transform">
            ...
            <p className="text-xl leading-relaxed max-w-lg font-body" style={{color: '#F3F4F6', fontWeight: 600, textShadow: '0 2px 4px rgba(0,0,0,0.5)'}}>
